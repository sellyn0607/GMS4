function addUI() {
	...
	+'            <a class="icon icon-sns-circle-md-kakao-talk signup-form__social__button" href="/users/auth/kakao">'
	+'<img class="manImg" src='+$.img()+'/katalk.JPG ></img></a>'
	+'        </section>'
	+'        <hr class="border-gray-light-more signup-form__divider">'
	...
	+'                    </div>'
	+'</form>        </section>'
	+'        <button id="join_form_btn" class="btn btn-priority" type="submit" form="new_normal_user">'
	+'            회원가입하기'
	+'        </button>'
